...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", pincode=" + pincode
				+ ", username=" + username + ", email=" + email + ", enname="
				+ enname + ", ensurname=" + ensurname + ", enfullname="
				+ enfullname + ", thname=" + thname + ", thsurname="
				+ thsurname + ", thfullname=" + thfullname + ", orgcode="
				+ orgcode + ", orgname=" + orgname + ", orgdesc=" + orgdesc
				+ ", orglevel=" + orglevel + ", fccode=" + fccode + ", fcname="
				+ fcname + ", fcdesc=" + fcdesc + ", fchcode=" + fchcode
				+ ", fchname=" + fchname + ", fchdesc=" + fchdesc + ", sccode="
				+ sccode + ", scname=" + scname + ", scdesc=" + scdesc
				+ ", schcode=" + schcode + ", schname=" + schname
				+ ", schdesc=" + schdesc + ", dpcode=" + dpcode + ", dpname="
				+ dpname + ", dpdesc=" + dpdesc + ", dphcode=" + dphcode
				+ ", dphname=" + dphname + ", dphdesc=" + dphdesc + ", bucode="
				+ bucode + ", buname=" + buname + ", budesc=" + budesc
				+ ", buhcode=" + buhcode + ", buhname=" + buhname
				+ ", buhdesc=" + buhdesc + ", cocode=" + cocode + ", coname="
				+ coname + ", phone=" + phone + ", mobile=" + mobile
				+ ", positionId=" + positionId + ", position=" + position
				+ ", managerPin=" + managerPin + ", managerUsername="
				+ managerUsername + ", managerEmail=" + managerEmail
				+ ", managerEnname=" + managerEnname + ", managerEnsurname="
				+ managerEnsurname + ", createdDate=" + createdDate
